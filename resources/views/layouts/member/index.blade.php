        ...
        <div class="box">
          <div class="box-header">
            <div class="row">
              <div class="col-xs-12">
                <div class="col-md-2">
                  <a href="{{ route('member.create') }}" class="btn btn-primary btn-rounded btn-fw">
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="{{route('member.show', $member->id)}}"><i class="fa fa-folder-open">&nbsp;
                                Detail</i></a></li>
                          <li><a href="{{ route('member.edit',$member->id) }}"><i class="fa fa-edit">&nbsp; Edit</i></a>
                          </li>
                          <li class="divider"></li>
                          <li>
                            <a href="">
                              <form action="{{ route('member.destroy', $member->id) }}" method="POST">
                                @csrf
                                <button class="btn btn-block btn-danger" type="submit" name="delete"
                                  onclick="javascript: return confirm('Hapus data dengan nama {{$member->nama}}')">
